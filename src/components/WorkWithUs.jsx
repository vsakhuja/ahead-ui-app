...
const WorkWithUs = () => {
  ...
  return (
    <div className="px-20 my-32">
      <section className="mt-16 rounded-2xl bg-violet-100 p-12 px-16" ref={ref}>
        {inView && (
          <div>
            ...
            <div className="mt-12 flex gap-20 overflow-hidden">
              <div className="grow">
                <div className="rounded-2xl bg-white  pt-8 max-w-[30rem] shadow-lg">
                  ...
                  >
                    <Image width={60} height={60} alt="" src="/assets/ghost.png" />
                  </motion.div>
                  ...
                  <div className="flex flex-col gap-2 pt-8  p-4 rounded-2xl  mt-8 bg-orange-50">
                    ...
                    <p className="font-normal">
                      Lorem ipsum, dolor sit amet consectetur adipisicing elit.
                      Dolore temporibus dignissimos, laboriosam corporis
                      deleniti quod quidem explicabo? Repellendus officiis odit
                      corrupti ducimus soluta dolor accusamus repellat, nostrum
                      suscipit, distinctio ipsam!
                    </p>
                  </div>
                </div>
              </div>
