  ...
  return (
    <>
      <motion.div
        ...
        className="bg-[#fefbec] rounded-lg hover:bg-[#FFEFD5] hover:cursor-pointer"
      >
        <div className="rounded-2.5xl  p-6 px-12 ">
          <h2 className="text-xl font-bold">{vac.jobTitle}</h2>

          <ul className="text-sm font-semibold list-disc pl-4">
            <li className="p-1">{vac.position}</li>
            <li className="p-1">{vac.location}</li>
            <li className="p-1">{vac.pay}</li>
          </ul>
        </div>
        {isButtonVisible && (
          <motion.button
            ...
            className="w-50 ml-27 mx-10 cursor-pointer text-white bg-black rounded-full px-4 py-4"
          >
            See details
          </motion.button>
        )}
